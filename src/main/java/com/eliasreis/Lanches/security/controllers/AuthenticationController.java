...
import com.eliasreis.Lanches.security.dto.JwtAuthenticationDto;
import com.eliasreis.Lanches.security.dto.TokenDto;
import com.eliasreis.Lanches.security.utils.JwtTokenUtil;
...
public class AuthenticationController {
	...
	public ResponseEntity<Response<TokenDto>> gerarTokenJwt(@Valid @RequestBody JwtAuthenticationDto authenticationDto,
		...
		response.setObjeto(new TokenDto(token));
	...
	public ResponseEntity<Response<TokenDto>> gerarRefreshTokenJwt(HttpServletRequest request) {
		...
		response.setObjeto(new TokenDto(refreshedToken));
